...
constexpr std::string_view kClientName = "asg-subagent-stop";
constexpr std::string_view kFeatureKey = "SG_FEATURE_SUBAGENT_STOP";
...
int main(int argc, char** argv) {
  ...
  if (!sg::ExchangeRequest(socket_path, sg::Hook::kSubagentStop, input,
                           &response, &error)) {
