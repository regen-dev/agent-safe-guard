...
constexpr std::string_view kClientName = "asg-stop";
constexpr std::string_view kFeatureKey = "SG_FEATURE_STOP";
...
int main(int argc, char** argv) {
  ...
  if (!sg::ExchangeRequest(socket_path, sg::Hook::kStop, input, &response,
                           &error)) {
