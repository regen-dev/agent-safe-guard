...
constexpr std::string_view kClientName = "asg-pre-compact";
constexpr std::string_view kFeatureKey = "SG_FEATURE_PRE_COMPACT";
...
int main(int argc, char** argv) {
  ...
  if (!sg::ExchangeRequest(socket_path, sg::Hook::kPreCompact, input, &response,
                           &error)) {
