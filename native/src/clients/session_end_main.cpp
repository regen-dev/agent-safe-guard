...
constexpr std::string_view kClientName = "asg-session-end";
constexpr std::string_view kFeatureKey = "SG_FEATURE_SESSION_END";
...
int main(int argc, char** argv) {
  ...
  if (!sg::ExchangeRequest(socket_path, sg::Hook::kSessionEnd, input, &response,
                           &error)) {
