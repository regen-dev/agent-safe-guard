...
constexpr std::string_view kClientName = "asg-tool-error";
constexpr std::string_view kFeatureKey = "SG_FEATURE_TOOL_ERROR";
...
int main(int argc, char** argv) {
  ...
  if (!sg::ExchangeRequest(socket_path, sg::Hook::kToolError, input, &response,
                           &error)) {
